...
var $strongName = '2E6084CFD764725C4E35E1934C3A78E0';
var $gwt = {};
...
var $intern_0 = 2147483647, $intern_1 = {3:1, 4:1}, $intern_2 = {3:1, 7:1, 4:1}, $intern_3 = {3:1, 166:1}, $intern_4 = {3:1}, $intern_5 = {71:1, 24:1, 3:1, 17:1, 18:1}, $intern_6 = {42:1, 3:1, 7:1, 4:1}, $intern_7 = 4194303, $intern_8 = 1048575, $intern_9 = 524288, $intern_10 = 4194304, $intern_11 = 17592186044416, $intern_12 = -9223372036854775808, $intern_13 = 65536, $intern_14 = 131072, $intern_15 = 16777216, $intern_16 = 33554432, $intern_17 = 67108864, $intern_18 = {35:1, 25:1, 31:1, 30:1, 36:1, 20:1, 16:1}, $intern_19 = {35:1, 25:1, 31:1, 30:1, 36:1, 51:1, 20:1, 16:1}, $intern_20 = {45:1}, $intern_21 = {3:1, 6:1, 61:1};
...
;
stringCastMap = {3:1, 199:1, 17:1, 2:1};
modernizeBrowser();
...
defineClass(26, 94, {26:1, 3:1, 7:1, 4:1}, JavaScriptException);
...
defineClass(123, 167, {}, SchedulerImpl);
var INSTANCE;
...
var collector;
defineClass(179, 1, {});
var Lcom_google_gwt_core_client_impl_StackTraceCreator$Collector_2_classLit = createForClass('com.google.gwt.core.client.impl', 'StackTraceCreator/Collector', 179);
function StackTraceCreator$CollectorLegacy(){
}

defineClass(95, 179, {}, StackTraceCreator$CollectorLegacy);
...
;
var Lcom_google_gwt_core_client_impl_StackTraceCreator$CollectorModern_2_classLit = createForClass('com.google.gwt.core.client.impl', 'StackTraceCreator/CollectorModern', 180);
function StackTraceCreator$CollectorModernNoSourceMap(){
  $clinit_StackTraceCreator$CollectorModern();
}

defineClass(96, 180, {}, StackTraceCreator$CollectorModernNoSourceMap);
...
defineClass(18, 1, {3:1, 17:1, 18:1});
...
function values_0(){
  ...
  return initValues(getClassLiteralForArray(Lcom_google_gwt_dom_client_Style$TextAlign_2_classLit, 1), $intern_4, 24, 0, [CENTER, JUSTIFY, LEFT, RIGHT]);
}

defineClass(24, 18, $intern_5);
...
defineClass(158, 24, $intern_5, Style$TextAlign$1);
var Lcom_google_gwt_dom_client_Style$TextAlign$1_2_classLit = createForEnum('com.google.gwt.dom.client', 'Style/TextAlign/1', 158, null);
function Style$TextAlign$2(){
  Style$TextAlign.call(this, 'JUSTIFY', 1);
}

defineClass(159, 24, $intern_5, Style$TextAlign$2);
var Lcom_google_gwt_dom_client_Style$TextAlign$2_2_classLit = createForEnum('com.google.gwt.dom.client', 'Style/TextAlign/2', 159, null);
function Style$TextAlign$3(){
  Style$TextAlign.call(this, 'LEFT', 2);
}

defineClass(160, 24, $intern_5, Style$TextAlign$3);
var Lcom_google_gwt_dom_client_Style$TextAlign$3_2_classLit = createForEnum('com.google.gwt.dom.client', 'Style/TextAlign/3', 160, null);
function Style$TextAlign$4(){
  Style$TextAlign.call(this, 'RIGHT', 3);
}

defineClass(161, 24, $intern_5, Style$TextAlign$4);
var Lcom_google_gwt_dom_client_Style$TextAlign$4_2_classLit = createForEnum('com.google.gwt.dom.client', 'Style/TextAlign/4', 161, null);
defineClass(190, 1, {});
_.toString$ = function toString_3(){
  return 'An event type';
}
;
var Lcom_google_web_bindery_event_shared_Event_2_classLit = createForClass('com.google.web.bindery.event.shared', 'Event', 190);
...
defineClass(191, 190, {});
_.dead = false;
var Lcom_google_gwt_event_shared_GwtEvent_2_classLit = createForClass('com.google.gwt.event.shared', 'GwtEvent', 191);
...
defineClass(162, 191, {}, CloseEvent_0);
...
;
var TYPE;
var Lcom_google_gwt_event_logical_shared_CloseEvent_2_classLit = createForClass('com.google.gwt.event.logical.shared', 'CloseEvent', 162);
defineClass(135, 1, {});
...
_.index_0 = 0;
var nextHashCode = 0;
var Lcom_google_web_bindery_event_shared_Event$Type_2_classLit = createForClass('com.google.web.bindery.event.shared', 'Event/Type', 135);
function GwtEvent$Type(){
  this.index_0 = ++nextHashCode;
}

defineClass(83, 135, {}, GwtEvent$Type);
var Lcom_google_gwt_event_shared_GwtEvent$Type_2_classLit = createForClass('com.google.gwt.event.shared', 'GwtEvent/Type', 83);
...
defineClass(81, 1, {25:1});
var Lcom_google_gwt_event_shared_HandlerManager_2_classLit = createForClass('com.google.gwt.event.shared', 'HandlerManager', 81);
defineClass(192, 1, {});
...
function $doFire(this$static, event_0){
  ...
  try {
    ...
    while (this$static.isReverseOrder?it.hasPrevious():it.hasNext()) {
      ...
      try {
        event_0.dispatch(dynamicCast(handler, 200));
      }
       catch ($e0) {
        $e0 = wrap($e0);
        if (instanceOf($e0, 4)) {
...
function $ensureHandlerList(this$static, type_0, source){
  ...
  sourceMap = dynamicCast($get_1(this$static.map_0, type_0), 44);
  if (!sourceMap) {
    sourceMap = new HashMap;
    $put_0(this$static.map_0, type_0, sourceMap);
  }
  handlers = dynamicCast(sourceMap.get_0(source), 6);
  if (!handlers) {
...
function $getHandlerList(this$static, type_0){
  ...
  handlers = dynamicCast(sourceMap.get_0(null), 6);
  if (!handlers) {
    return $clinit_Collections() , $clinit_Collections() , EMPTY_LIST;
  }
  return handlers;
...
var Lcom_google_web_bindery_event_shared_SimpleEventBus_2_classLit = createForClass('com.google.web.bindery.event.shared', 'SimpleEventBus', 136);
function HandlerManager$Bus(){
  this.map_0 = new HashMap;
  this.isReverseOrder = false;
}

defineClass(137, 136, {}, HandlerManager$Bus);
var Lcom_google_gwt_event_shared_HandlerManager$Bus_2_classLit = createForClass('com.google.gwt.event.shared', 'HandlerManager/Bus', 137);
...
defineClass(42, 11, $intern_6, UmbrellaException);
...
defineClass(85, 42, $intern_6, UmbrellaException_0);
...
function values_1(){
  ...
  return initValues(getClassLiteralForArray(Lcom_google_gwt_i18n_client_HasDirection$Direction_2_classLit, 1), $intern_4, 52, 0, [RTL, LTR, DEFAULT]);
}

defineClass(52, 18, {52:1, 3:1, 17:1, 18:1}, HasDirection$Direction);
var DEFAULT, LTR, RTL;
var Lcom_google_gwt_i18n_client_HasDirection$Direction_2_classLit = createForEnum('com.google.gwt.i18n.client', 'HasDirection/Direction', 52, values_1);
defineClass(195, 1, {});
...
;
var Lcom_google_gwt_json_client_JSONValue_2_classLit = createForClass('com.google.gwt.json.client', 'JSONValue', 195);
...
defineClass(28, 195, {28:1}, JSONArray, JSONArray_0);
_.equals$ = function equals_1(other){
  if (!instanceOf(other, 28)) {
    return false;
  }
  return this.jsArray == dynamicCast(other, 28).jsArray;
}
;
...
;
var Lcom_google_gwt_json_client_JSONArray_2_classLit = createForClass('com.google.gwt.json.client', 'JSONArray', 28);
...
defineClass(89, 195, {}, JSONBoolean);
...
_.value_0 = false;
var FALSE, TRUE;
var Lcom_google_gwt_json_client_JSONBoolean_2_classLit = createForClass('com.google.gwt.json.client', 'JSONBoolean', 89);
...
defineClass(69, 11, $intern_2, JSONException, JSONException_0);
var Lcom_google_gwt_json_client_JSONException_2_classLit = createForClass('com.google.gwt.json.client', 'JSONException', 69);
...
;
var instance;
var Lcom_google_gwt_json_client_JSONNull_2_classLit = createForClass('com.google.gwt.json.client', 'JSONNull', 163);
...
defineClass(15, 195, {15:1}, JSONNumber);
_.equals$ = function equals_2(other){
  if (!instanceOf(other, 15)) {
    return false;
  }
  return this.value_0 == dynamicCast(other, 15).value_0;
}
;
...
;
_.value_0 = 0;
var Lcom_google_gwt_json_client_JSONNumber_2_classLit = createForClass('com.google.gwt.json.client', 'JSONNumber', 15);
...
defineClass(21, 195, {21:1}, JSONObject, JSONObject_0);
_.equals$ = function equals_3(other){
  if (!instanceOf(other, 21)) {
    return false;
  }
  return this.jsObject == dynamicCast(other, 21).jsObject;
}
;
...
;
var Lcom_google_gwt_json_client_JSONObject_2_classLit = createForClass('com.google.gwt.json.client', 'JSONObject', 21);
...
defineClass(12, 195, {12:1}, JSONString);
_.equals$ = function equals_4(other){
  if (!instanceOf(other, 12)) {
    return false;
  }
  return $equals_0(this.value_0, dynamicCast(other, 12).value_0);
}
;
...
;
var Lcom_google_gwt_json_client_JSONString_2_classLit = createForClass('com.google.gwt.json.client', 'JSONString', 12);
...
var Ljava_util_logging_Handler_2_classLit = createForClass('java.util.logging', 'Handler', 50);
function ConsoleLogHandler(){
  $setFormatter(this, new TextLogFormatter(true));
  $setLevel(this, ($clinit_Level() , ALL));
}

defineClass(140, 50, {50:1}, ConsoleLogHandler);
...
;
var Lcom_google_gwt_logging_client_ConsoleLogHandler_2_classLit = createForClass('com.google.gwt.logging.client', 'ConsoleLogHandler', 140);
function DevelopmentModeLogHandler(){
  $setFormatter(this, new TextLogFormatter(false));
  $setLevel(this, ($clinit_Level() , ALL));
}

defineClass(141, 50, {50:1}, DevelopmentModeLogHandler);
_.publish = function publish_0(record){
  return;
}
;
var Lcom_google_gwt_logging_client_DevelopmentModeLogHandler_2_classLit = createForClass('com.google.gwt.logging.client', 'DevelopmentModeLogHandler', 141);
...
function $setLevels(l){
  ...
  levelParam = (ensureListParameterMap() , paramsForName = dynamicCast(listParamMap.get_0('logLevel'), 6) , !paramsForName?null:dynamicCastToString(paramsForName.get_1(paramsForName.size_1() - 1)));
  level = levelParam == null?null:($clinit_Level() , $parse_0(levelParam));
  level?$setLevel_0(l.impl, level):$setLevel_1(l, ($clinit_Level() , INFO));
}

defineClass(178, 1, {});
var Lcom_google_gwt_logging_client_LogConfiguration$LogConfigurationImplRegular_2_classLit = createForClass('com.google.gwt.logging.client', 'LogConfiguration/LogConfigurationImplRegular', 178);
function LogConfiguration$LogConfigurationImplSevere(){
}

defineClass(91, 178, {}, LogConfiguration$LogConfigurationImplSevere);
...
defineClass(196, 1, {});
var Ljava_util_logging_Formatter_2_classLit = createForClass('java.util.logging', 'Formatter', 196);
defineClass(197, 196, {});
var Lcom_google_gwt_logging_impl_FormatterImpl_2_classLit = createForClass('com.google.gwt.logging.impl', 'FormatterImpl', 197);
...
defineClass(87, 197, {}, TextLogFormatter);
_.showStackTraces = false;
var Lcom_google_gwt_logging_client_TextLogFormatter_2_classLit = createForClass('com.google.gwt.logging.client', 'TextLogFormatter', 87);
...
function $getHandlers(this$static){
  return dynamicCast($toArray(this$static.handlers, initDim(Ljava_util_logging_Handler_2_classLit, {3:1, 90:1}, 50, this$static.handlers.array.length, 0, 1)), 90);
}
...
function $log_0(this$static, record){
  ...
  if ($getEffectiveLevel(this$static).intValue() <= 1000) {
    for (handler$array0 = dynamicCast($toArray(this$static.handlers, initDim(Ljava_util_logging_Handler_2_classLit, {3:1, 90:1}, 50, this$static.handlers.array.length, 0, 1)), 90) , handler$index0 = 0 , handler$max0 = handler$array0.length; handler$index0 < handler$max0; ++handler$index0) {
...
var Lcom_google_gwt_logging_impl_LoggerImplRegular_2_classLit = createForClass('com.google.gwt.logging.impl', 'LoggerImplRegular', 115);
function LoggerImplSevere(){
  this.useParentHandlers = true;
  this.handlers = new ArrayList;
}

defineClass(65, 115, {}, LoggerImplSevere);
var Lcom_google_gwt_logging_impl_LoggerImplSevere_2_classLit = createForClass('com.google.gwt.logging.impl', 'LoggerImplSevere', 65);
defineClass(186, 1, {});
...
defineClass(188, 187, {});
var Ljava_io_PrintStream_2_classLit = createForClass('java.io', 'PrintStream', 188);
function StackTracePrintStream(builder){
  this.builder = builder;
}

defineClass(153, 188, {}, StackTracePrintStream);
...
defineClass(134, 191, {}, Window$ClosingEvent);
...
;
var TYPE_0;
var Lcom_google_gwt_user_client_Window$ClosingEvent_2_classLit = createForClass('com.google.gwt.user.client', 'Window/ClosingEvent', 134);
function buildListParamMap(queryString){
  ...
  if (queryString != null && queryString.length > 1) {
    ...
    for (kvPair$array = $split(qs, '&', 0) , kvPair$index = 0 , kvPair$max = kvPair$array.length; kvPair$index < kvPair$max; ++kvPair$index) {
      ...
      values = dynamicCast(out.get_0(key), 6);
      if (!values) {
  ...
  for (entry$iterator = out.entrySet_0().iterator(); entry$iterator.hasNext();) {
    entry = dynamicCast(entry$iterator.next_0(), 5);
    entry.setValue(unmodifiableList(dynamicCast(entry.getValue(), 6)));
  }
...
defineClass(82, 81, {25:1}, Window$WindowHandlers);
var Lcom_google_gwt_user_client_Window$WindowHandlers_2_classLit = createForClass('com.google.gwt.user.client', 'Window/WindowHandlers', 82);
...
;
var Lcom_google_gwt_user_client_ui_Panel_2_classLit = createForClass('com.google.gwt.user.client.ui', 'Panel', 193);
...
;
var Lcom_google_gwt_user_client_ui_ComplexPanel_2_classLit = createForClass('com.google.gwt.user.client.ui', 'ComplexPanel', 84);
...
defineClass(146, 85, $intern_6, AttachDetachException);
...
defineClass(149, 84, $intern_18);
var Lcom_google_gwt_user_client_ui_CellPanel_2_classLit = createForClass('com.google.gwt.user.client.ui', 'CellPanel', 149);
...
defineClass(155, 1, {}, DirectionalTextHelper);
var Lcom_google_gwt_user_client_ui_DirectionalTextHelper_2_classLit = createForClass('com.google.gwt.user.client.ui', 'DirectionalTextHelper', 155);
...
defineClass(194, 1, {});
var Lcom_google_gwt_user_client_ui_HasHorizontalAlignment$AutoHorizontalAlignmentConstant_2_classLit = createForClass('com.google.gwt.user.client.ui', 'HasHorizontalAlignment/AutoHorizontalAlignmentConstant', 194);
function HasHorizontalAlignment$HorizontalAlignmentConstant(textAlignString){
  this.textAlignString = textAlignString;
}

defineClass(57, 194, {}, HasHorizontalAlignment$HorizontalAlignmentConstant);
...
defineClass(86, 16, $intern_18);
var Lcom_google_gwt_user_client_ui_LabelBase_2_classLit = createForClass('com.google.gwt.user.client.ui', 'LabelBase', 86);
function Label(){
  LabelBase.call(this, $doc.createElement('div'));
  ($clinit_DOM() , this.element).className = 'gwt-Label';
}

defineClass(58, 86, $intern_18, Label);
var Lcom_google_gwt_user_client_ui_Label_2_classLit = createForClass('com.google.gwt.user.client.ui', 'Label', 58);
...
defineClass(51, 142, $intern_19, RootPanel);
...
defineClass(145, 1, {200:1}, RootPanel$2);
...
defineClass(143, 51, $intern_19, RootPanel$DefaultRootPanel);
...
defineClass(150, 149, $intern_18, VerticalPanel);
...
;
var Lcom_google_gwt_user_client_ui_VerticalPanel_2_classLit = createForClass('com.google.gwt.user.client.ui', 'VerticalPanel', 150);
...
function $insert(this$static, w, beforeIndex){
  ...
  if (this$static.size_0 == this$static.array.length) {
    newArray = initDim(Lcom_google_gwt_user_client_ui_Widget_2_classLit, $intern_4, 16, this$static.array.length * 2, 0, 1);
...
function WidgetCollection(){
  this.array = initDim(Lcom_google_gwt_user_client_ui_Widget_2_classLit, $intern_4, 16, 4, 0, 1);
}

defineClass(157, 1, {}, WidgetCollection);
_.iterator = function iterator_1(){
  return new WidgetCollection$WidgetIterator(this);
}
;
_.size_0 = 0;
var Lcom_google_gwt_user_client_ui_WidgetCollection_2_classLit = createForClass('com.google.gwt.user.client.ui', 'WidgetCollection', 157);
...
defineClass(88, 1, {}, WidgetCollection$WidgetIterator);
...
;
_.index_0 = 0;
var Lcom_google_gwt_user_client_ui_WidgetCollection$WidgetIterator_2_classLit = createForClass('com.google.gwt.user.client.ui', 'WidgetCollection/WidgetIterator', 88);
...
defineClass(93, 13, $intern_1, UserAgentAsserter$UserAgentAssertionError);
...
defineClass(138, 1, {}, SimpleEventBus$1);
var Lcom_google_web_bindery_event_shared_SimpleEventBus$1_2_classLit = createForClass('com.google.web.bindery.event.shared', 'SimpleEventBus/1', 138);
...
defineClass(139, 1, {201:1}, SimpleEventBus$2);
var Lcom_google_web_bindery_event_shared_SimpleEventBus$2_2_classLit = createForClass('com.google.web.bindery.event.shared', 'SimpleEventBus/2', 139);
...
defineClass(151, 1, $intern_4, DocumentCompleteJSON);
var Lfdi_ucm_server_interconect_model_DocumentCompleteJSON_2_classLit = createForClass('fdi.ucm.server.interconect.model', 'DocumentCompleteJSON', 151);
...
defineClass(154, 1, $intern_4, DocumentsJSON);
var Lfdi_ucm_server_interconect_model_DocumentsJSON_2_classLit = createForClass('fdi.ucm.server.interconect.model', 'DocumentsJSON', 154);
...
defineClass(43, 1, {43:1, 3:1}, GrammarJSON);
var Lfdi_ucm_server_interconect_model_GrammarJSON_2_classLit = createForClass('fdi.ucm.server.interconect.model', 'GrammarJSON', 43);
...
defineClass(70, 1, {70:1, 3:1}, OperationalValueJSON);
var Lfdi_ucm_server_interconect_model_OperationalValueJSON_2_classLit = createForClass('fdi.ucm.server.interconect.model', 'OperationalValueJSON', 70);
...
defineClass(29, 1, {29:1, 3:1}, OperationalValueTypeJSON);
var Lfdi_ucm_server_interconect_model_OperationalValueTypeJSON_2_classLit = createForClass('fdi.ucm.server.interconect.model', 'OperationalValueTypeJSON', 29);
...
defineClass(8, 1, {8:1, 3:1}, StructureJSON);
_.Browseable = false;
_.Extended = false;
_.Filtro = false;
_.Multivalued = false;
...
var Lfdi_ucm_server_interconect_model_StructureJSON_2_classLit = createForClass('fdi.ucm.server.interconect.model', 'StructureJSON', 8);
...
function values_2(){
  ...
  return initValues(getClassLiteralForArray(Lfdi_ucm_server_interconect_model_StructureJSON$TypeOfStructureEnum_2_classLit, 1), $intern_4, 34, 0, [Text_0, Resource, Link_0, Basic]);
}

defineClass(34, 18, {34:1, 3:1, 17:1, 18:1}, StructureJSON$TypeOfStructureEnum);
var Basic, Link_0, Resource, Text_0;
var Lfdi_ucm_server_interconect_model_StructureJSON$TypeOfStructureEnum_2_classLit = createForEnum('fdi.ucm.server.interconect.model', 'StructureJSON/TypeOfStructureEnum', 34, values_2);
function $clinit_StructureJSON$TypeOfStructureEnum$Map(){
  $clinit_StructureJSON$TypeOfStructureEnum$Map = emptyMethod;
  $MAP = createValueOfMap(($clinit_StructureJSON$TypeOfStructureEnum() , initValues(getClassLiteralForArray(Lfdi_ucm_server_interconect_model_StructureJSON$TypeOfStructureEnum_2_classLit, 1), $intern_4, 34, 0, [Text_0, Resource, Link_0, Basic])));
}
...
;
var Ljava_lang_AbstractStringBuilder_2_classLit = createForClass('java.lang', 'AbstractStringBuilder', 63);
function ArithmeticException(){
  RuntimeException_0.call(this, 'divide by zero');
}

defineClass(101, 11, $intern_2, ArithmeticException);
var Ljava_lang_ArithmeticException_2_classLit = createForClass('java.lang', 'ArithmeticException', 101);
function ArrayStoreException(){
  RuntimeException.call(this);
}

defineClass(54, 11, $intern_2, ArrayStoreException);
...
defineClass(46, 1, {3:1, 46:1, 17:1}, Boolean_0);
...
defineClass(40, 11, $intern_2, ClassCastException);
var Ljava_lang_ClassCastException_2_classLit = createForClass('java.lang', 'ClassCastException', 40);
...
defineClass(14, 55, {3:1, 17:1, 14:1, 55:1}, Double);
...
;
_.value_0 = 0;
var Ljava_lang_Double_2_classLit = createForClass('java.lang', 'Double', 14);
function IllegalArgumentException(message){
  RuntimeException_0.call(this, message);
}

defineClass(48, 11, $intern_2, IllegalArgumentException);
...
defineClass(59, 11, $intern_2, IllegalStateException);
...
defineClass(53, 11, $intern_2, IndexOutOfBoundsException, IndexOutOfBoundsException_0);
...
defineClass(41, 55, {3:1, 17:1, 41:1, 55:1}, Integer);
...
function $clinit_Integer$BoxedValues(){
  ...
  boxedValues_0 = initDim(Ljava_lang_Integer_2_classLit, $intern_4, 41, 256, 0, 1);
}

var boxedValues_0;
function $equals(this$static, o){
  return instanceOf(o, 22) && eq(dynamicCast(o, 22).value_0, this$static.value_0);
}
...
defineClass(22, 55, {3:1, 17:1, 22:1, 55:1}, Long);
...
var Ljava_lang_Long_2_classLit = createForClass('java.lang', 'Long', 22);
function $clinit_Long$BoxedValues(){
  $clinit_Long$BoxedValues = emptyMethod;
  boxedValues_1 = initDim(Ljava_lang_Long_2_classLit, $intern_4, 22, 256, 0, 1);
}
...
defineClass(37, 11, $intern_2, NullPointerException, NullPointerException_0);
...
defineClass(19, 48, $intern_2, NumberFormatException);
var Ljava_lang_NumberFormatException_2_classLit = createForClass('java.lang', 'NumberFormatException', 19);
...
defineClass(27, 63, {199:1}, StringBuilder, StringBuilder_0, StringBuilder_1);
...
defineClass(49, 11, $intern_2, UnsupportedOperationException, UnsupportedOperationException_0);
var Ljava_lang_UnsupportedOperationException_2_classLit = createForClass('java.lang', 'UnsupportedOperationException', 49);
function $addAll(this$static, c){
  var changed, e, e$iterator;
  checkNotNull(c);
  changed = false;
  for (e$iterator = new AbstractHashMap$EntrySetIterator(c.this$01); $hasNext(e$iterator);) {
    e = (checkStructuralChange(e$iterator.this$01, e$iterator) , checkCriticalElement($hasNext(e$iterator)) , dynamicCast(e$iterator.current.next_0(), 5));
...
;
var Ljava_util_AbstractCollection_2_classLit = createForClass('java.util', 'AbstractCollection', 182);
...
function $implFindEntry(this$static, key){
  ...
  for (iter = new AbstractHashMap$EntrySetIterator((new AbstractHashMap$EntrySet(this$static)).this$01); $hasNext(iter);) {
    entry = (checkStructuralChange(iter.this$01, iter) , checkCriticalElement($hasNext(iter)) , dynamicCast(iter.current.next_0(), 5));
    k = entry.getKey();
...
_.toString$ = function toString_21(){
  ...
  for (entry$iterator = new AbstractHashMap$EntrySetIterator((new AbstractHashMap$EntrySet(this)).this$01); $hasNext(entry$iterator);) {
    entry = (checkStructuralChange(entry$iterator.this$01, entry$iterator) , checkCriticalElement($hasNext(entry$iterator)) , dynamicCast(entry$iterator.current.next_0(), 5));
    comma?(sb.string += ', ' , sb):(comma = true);
...
;
var Ljava_util_AbstractMap_2_classLit = createForClass('java.util', 'AbstractMap', 181);
...
;
var Ljava_util_AbstractSet_2_classLit = createForClass('java.util', 'AbstractSet', 183);
function $contains(this$static, o){
  if (instanceOf(o, 5)) {
    return $containsEntry(this$static.this$01, dynamicCast(o, 5));
  }
  return false;
}
...
defineClass(33, 183, $intern_20, AbstractHashMap$EntrySet);
...
function $next_0(this$static){
  return checkStructuralChange(this$static.this$01, this$static) , checkCriticalElement($hasNext(this$static)) , dynamicCast(this$static.current.next_0(), 5);
}
...
;
var Ljava_util_AbstractList_2_classLit = createForClass('java.util', 'AbstractList', 184);
...
;
_.i = 0;
var Ljava_util_AbstractList$IteratorImpl_2_classLit = createForClass('java.util', 'AbstractList/IteratorImpl', 9);
...
defineClass(110, 9, {}, AbstractList$ListIteratorImpl);
...
;
var Ljava_util_AbstractList$ListIteratorImpl_2_classLit = createForClass('java.util', 'AbstractList/ListIteratorImpl', 110);
...
defineClass(73, 183, $intern_20, AbstractMap$1);
...
;
var Ljava_util_AbstractMap$1_2_classLit = createForClass('java.util', 'AbstractMap/1', 73);
...
;
var Ljava_util_AbstractMapEntry_2_classLit = createForClass('java.util', 'AbstractMapEntry', 185);
...
;
var Ljava_util_AbstractSequentialList_2_classLit = createForClass('java.util', 'AbstractSequentialList', 198);
...
defineClass(10, 184, $intern_21, ArrayList);
...
function unmodifiableList(list){
  $clinit_Collections();
  return instanceOf(list, 61)?new Collections$UnmodifiableRandomAccessList(list):new Collections$UnmodifiableList(list);
}
...
defineClass(102, 184, $intern_21, Collections$EmptyList);
...
;
var Ljava_util_Collections$EmptyList_2_classLit = createForClass('java.util', 'Collections/EmptyList', 102);
...
defineClass(103, 1, {}, Collections$EmptyListIterator);
...
;
var INSTANCE_0;
var Ljava_util_Collections$EmptyListIterator_2_classLit = createForClass('java.util', 'Collections/EmptyListIterator', 103);
...
defineClass(75, 74, {6:1}, Collections$UnmodifiableList);
...
defineClass(104, 1, {44:1}, Collections$UnmodifiableMap);
...
;
var Ljava_util_Collections$UnmodifiableMap_2_classLit = createForClass('java.util', 'Collections/UnmodifiableMap', 104);
defineClass(105, 74, $intern_20);
...
;
var Ljava_util_Collections$UnmodifiableSet_2_classLit = createForClass('java.util', 'Collections/UnmodifiableSet', 105);
function Collections$UnmodifiableMap$UnmodifiableEntrySet(s){
  Collections$UnmodifiableCollection.call(this, s);
}

defineClass(106, 105, $intern_20, Collections$UnmodifiableMap$UnmodifiableEntrySet);
...
;
var Ljava_util_Collections$UnmodifiableMap$UnmodifiableEntrySet_2_classLit = createForClass('java.util', 'Collections/UnmodifiableMap/UnmodifiableEntrySet', 106);
function Collections$UnmodifiableMap$UnmodifiableEntrySet$1(val$it){
  this.val$it2 = val$it;
}

defineClass(109, 1, {}, Collections$UnmodifiableMap$UnmodifiableEntrySet$1);
_.hasNext = function hasNext_5(){
  return this.val$it2.hasNext();
}
;
_.next_0 = function next_6(){
  return new Collections$UnmodifiableMap$UnmodifiableEntrySet$UnmodifiableEntry(dynamicCast(this.val$it2.next_0(), 5));
}
;
var Ljava_util_Collections$UnmodifiableMap$UnmodifiableEntrySet$1_2_classLit = createForClass('java.util', 'Collections/UnmodifiableMap/UnmodifiableEntrySet/1', 109);
function Collections$UnmodifiableMap$UnmodifiableEntrySet$UnmodifiableEntry(entry){
  this.entry = entry;
}

defineClass(107, 1, {5:1}, Collections$UnmodifiableMap$UnmodifiableEntrySet$UnmodifiableEntry);
...
;
var Ljava_util_Collections$UnmodifiableMap$UnmodifiableEntrySet$UnmodifiableEntry_2_classLit = createForClass('java.util', 'Collections/UnmodifiableMap/UnmodifiableEntrySet/UnmodifiableEntry', 107);
function Collections$UnmodifiableRandomAccessList(list){
  Collections$UnmodifiableList.call(this, list);
}

defineClass(108, 75, {6:1, 61:1}, Collections$UnmodifiableRandomAccessList);
var Ljava_util_Collections$UnmodifiableRandomAccessList_2_classLit = createForClass('java.util', 'Collections/UnmodifiableRandomAccessList', 108);
...
defineClass(164, 11, $intern_2, ConcurrentModificationException);
...
defineClass(60, 1, {3:1, 17:1, 60:1}, Date_0);
_.equals$ = function equals_19(obj){
  return instanceOf(obj, 60) && eq(fromDouble(this.jsdate.getTime()), fromDouble(dynamicCast(obj, 60).jsdate.getTime()));
}
;
...
defineClass(23, 97, {3:1, 44:1}, HashMap);
...
defineClass(67, 183, {3:1, 45:1}, HashSet);
...
defineClass(79, 1, {}, InternalJsHashCodeMap);
...
;
var Ljava_util_InternalJsHashCodeMap_2_classLit = createForClass('java.util', 'InternalJsHashCodeMap', 79);
...
function InternalJsHashCodeMap$1(this$0){
  ...
  this.chain = initDim(Ljava_util_Map$Entry_2_classLit, $intern_4, 5, 0, 0, 1);
}
...
defineClass(120, 79, {}, InternalJsHashCodeMap$InternalJsHashCodeMapLegacy);
...
defineClass(121, 10, $intern_21, InternalJsHashCodeMap$InternalJsHashCodeMapLegacy$1);
...
defineClass(78, 185, {5:1}, InternalJsStringMap$2);
...
defineClass(111, 64, {}, InternalJsStringMap$InternalJsStringMapLegacy);
...
defineClass(113, 10, $intern_21, InternalJsStringMap$InternalJsStringMapLegacy$1);
...
defineClass(112, 64, {}, InternalJsStringMap$InternalJsStringMapWithKeysWorkaround);
...
defineClass(38, 198, {3:1, 6:1}, LinkedList, LinkedList_0);
...
;
_.size_0 = 0;
var Ljava_util_LinkedList_2_classLit = createForClass('java.util', 'LinkedList', 38);
...
defineClass(156, 1, {}, LinkedList$ListIteratorImpl);
...
_.currentIndex = 0;
_.lastNode = null;
var Ljava_util_LinkedList$ListIteratorImpl_2_classLit = createForClass('java.util', 'LinkedList/ListIteratorImpl', 156);
function LinkedList$Node(){
}

defineClass(68, 1, {}, LinkedList$Node);
var Ljava_util_LinkedList$Node_2_classLit = createForClass('java.util', 'LinkedList/Node', 68);
var Ljava_util_Map$Entry_2_classLit = createForInterface('java.util', 'Map/Entry');
function NoSuchElementException(){
  RuntimeException.call(this);
}

defineClass(39, 11, {3:1, 7:1, 4:1, 39:1}, NoSuchElementException);
var Ljava_util_NoSuchElementException_2_classLit = createForClass('java.util', 'NoSuchElementException', 39);
...
var Ljava_util_logging_Level_2_classLit = createForClass('java.util.logging', 'Level', 189);
function Level$LevelAll(){
}

defineClass(124, 189, $intern_4, Level$LevelAll);
...
defineClass(125, 189, $intern_4, Level$LevelConfig);
...
defineClass(126, 189, $intern_4, Level$LevelFine);
...
defineClass(127, 189, $intern_4, Level$LevelFiner);
...
defineClass(128, 189, $intern_4, Level$LevelFinest);
...
defineClass(129, 189, $intern_4, Level$LevelInfo);
...
defineClass(130, 189, $intern_4, Level$LevelOff);
...
defineClass(131, 189, $intern_4, Level$LevelSevere);
...
defineClass(132, 189, $intern_4, Level$LevelWarning);
...
function $ensureLogger(this$static, name_0){
  ...
  logger = dynamicCast($getStringValue(this$static.loggerMap, name_0), 56);
  if (!logger) {
...
defineClass(56, 1, {56:1}, Logger);
var Ljava_util_logging_Logger_2_classLit = createForClass('java.util.logging', 'Logger', 56);
function $gotContext(this$static, listaS, contextId){
  ...
  for (structterJSON$iterator = new AbstractList$IteratorImpl(listaS); structterJSON$iterator.i < structterJSON$iterator.this$01_0.size_1();) {
    structterJSON = (checkCriticalElement(structterJSON$iterator.i < structterJSON$iterator.this$01_0.size_1()) , dynamicCast(structterJSON$iterator.this$01_0.get_1(structterJSON$iterator.i++), 8));
    if ($equals(dynamicCast($get_3(structterJSON.Id, 0), 22), contextId))
...
function $test(this$static, sS){
  ...
  if (SSPadre) {
    ...
    for (Gr$iterator = new AbstractList$IteratorImpl(this$static.Documento.Gramaticas); Gr$iterator.i < Gr$iterator.this$01_0.size_1();) {
      Gr = (checkCriticalElement(Gr$iterator.i < Gr$iterator.this$01_0.size_1()) , dynamicCast(Gr$iterator.this$01_0.get_1(Gr$iterator.i++), 43));
    ...
    for (Gr$iterator = new AbstractList$IteratorImpl(this$static.Documento.Gramaticas); Gr$iterator.i < Gr$iterator.this$01_0.size_1();) {
      Gr = (checkCriticalElement(Gr$iterator.i < Gr$iterator.this$01_0.size_1()) , dynamicCast(Gr$iterator.this$01_0.get_1(Gr$iterator.i++), 43));
      SSFin = $gotContext(this$static, Gr.ListaS, dynamicCast($get_3(sS.Id, 0), 22));
      if (SSFin) {
        GSFin = Gr;
        break;
      }
  ...
  for (OperaValTyJSON$iterator = new AbstractList$IteratorImpl(sS.Shows); OperaValTyJSON$iterator.i < OperaValTyJSON$iterator.this$01_0.size_1();) {
    OperaValTyJSON = (checkCriticalElement(OperaValTyJSON$iterator.i < OperaValTyJSON$iterator.this$01_0.size_1()) , dynamicCast(OperaValTyJSON$iterator.this$01_0.get_1(OperaValTyJSON$iterator.i++), 29));
  ...
  for (structureJSON$iterator0 = new AbstractList$IteratorImpl(ZonaBUsqueda); structureJSON$iterator0.i < structureJSON$iterator0.this$01_0.size_1();) {
    structureJSON = (checkCriticalElement(structureJSON$iterator0.i < structureJSON$iterator0.this$01_0.size_1()) , dynamicCast(structureJSON$iterator0.this$01_0.get_1(structureJSON$iterator0.i++), 8));
    ...
    if (structureJSON.TypeOfStructure == Text_0)
      for (ViewstructureJSON$iterator0 = new AbstractList$IteratorImpl(structureJSON.Shows); ViewstructureJSON$iterator0.i < ViewstructureJSON$iterator0.this$01_0.size_1();) {
        ViewstructureJSON = (checkCriticalElement(ViewstructureJSON$iterator0.i < ViewstructureJSON$iterator0.this$01_0.size_1()) , dynamicCast(ViewstructureJSON$iterator0.this$01_0.get_1(ViewstructureJSON$iterator0.i++), 29));
    ...
    if (structureJSON.TypeOfStructure == Resource)
      for (ViewstructureJSON$iterator = new AbstractList$IteratorImpl(structureJSON.Shows); ViewstructureJSON$iterator.i < ViewstructureJSON$iterator.this$01_0.size_1();) {
        ViewstructureJSON = (checkCriticalElement(ViewstructureJSON$iterator.i < ViewstructureJSON$iterator.this$01_0.size_1()) , dynamicCast(ViewstructureJSON$iterator.this$01_0.get_1(ViewstructureJSON$iterator.i++), 29));
  ...
  this$static.ImagenesBien.size_0 == 0 && (setCheck(Errores.array, Errores.array.length, 'I cant found Images structure element in this context fathe with view proto->type->image') , true);
  this$static.UteranciasBien.size_0 != 0 && !dynamicCast($get_2(this$static.UteranciasBien, 0), 8).Multivalued && (setCheck(Errores.array, Errores.array.length, 'Utterances structure element should be multivalued') , true);
  this$static.ImagenesBien.size_0 != 0 && !dynamicCast($get_2(this$static.ImagenesBien, 0), 8).Multivalued && (setCheck(Errores.array, Errores.array.length, 'Images structure element should be multivalued') , true);
  ...
  for (termElem$iterator = $listIterator(this$static.TermElements, 0); termElem$iterator.currentNode != termElem$iterator.this$01.tail;) {
    termElem = (checkCriticalElement(termElem$iterator.currentNode != termElem$iterator.this$01.tail) , termElem$iterator.lastNode = termElem$iterator.currentNode , termElem$iterator.currentNode = termElem$iterator.currentNode.next , ++termElem$iterator.currentIndex , dynamicCast(termElem$iterator.lastNode.value_0, 8));
    ...
    for (structureJSON$iterator1 = new AbstractList$IteratorImpl(termElem.Sons); structureJSON$iterator1.i < structureJSON$iterator1.this$01_0.size_1();) {
      structureJSON = (checkCriticalElement(structureJSON$iterator1.i < structureJSON$iterator1.this$01_0.size_1()) , dynamicCast(structureJSON$iterator1.this$01_0.get_1(structureJSON$iterator1.i++), 8));
      if (structureJSON.TypeOfStructure == Text_0)
        for (ViewstructureJSON$iterator = new AbstractList$IteratorImpl(structureJSON.Shows); ViewstructureJSON$iterator.i < ViewstructureJSON$iterator.this$01_0.size_1();) {
          ViewstructureJSON = (checkCriticalElement(ViewstructureJSON$iterator.i < ViewstructureJSON$iterator.this$01_0.size_1()) , dynamicCast(ViewstructureJSON$iterator.this$01_0.get_1(ViewstructureJSON$iterator.i++), 29));
    ...
    for (structureJSON$iterator = new AbstractList$IteratorImpl(termElem.Sons); structureJSON$iterator.i < structureJSON$iterator.this$01_0.size_1();) {
      structureJSON = (checkCriticalElement(structureJSON$iterator.i < structureJSON$iterator.this$01_0.size_1()) , dynamicCast(structureJSON$iterator.this$01_0.get_1(structureJSON$iterator.i++), 8));
      if (structureJSON.TypeOfStructure == Text_0)
        for (ViewstructureJSON$iterator = new AbstractList$IteratorImpl(structureJSON.Shows); ViewstructureJSON$iterator.i < ViewstructureJSON$iterator.this$01_0.size_1();) {
          ViewstructureJSON = (checkCriticalElement(ViewstructureJSON$iterator.i < ViewstructureJSON$iterator.this$01_0.size_1()) , dynamicCast(ViewstructureJSON$iterator.this$01_0.get_1(ViewstructureJSON$iterator.i++), 29));
  ...
  for (err$iterator0 = new AbstractList$IteratorImpl(Errores); err$iterator0.i < err$iterator0.this$01_0.size_1();) {
    err = (checkCriticalElement(err$iterator0.i < err$iterator0.this$01_0.size_1()) , dynamicCastToString(err$iterator0.this$01_0.get_1(err$iterator0.i++)));
    console_1('E2:' + err);
  }
  ...
  ListPosition.size_0 != 0 && dynamicCast(dynamicCast($get_2(ListPosition, 0), 5).getValue(), 6).isEmpty() && (setCheck(Errores.array, Errores.array.length, 'Term structure element should have almost one Position structure element with position view proto->type->position') , true);
  ListPosition.size_0 != 0 && !dynamicCast(dynamicCast($get_2(ListPosition, 0), 5).getValue(), 6).isEmpty() && !dynamicCast(dynamicCast(dynamicCast($get_2(ListPosition, 0), 5).getValue(), 6).get_1(0), 8).Multivalued && (setCheck(Errores.array, Errores.array.length, 'Position structure element should be multivalued') , true);
  ListSemantic.size_0 != 0 && dynamicCast(dynamicCast($get_2(ListSemantic, 0), 5).getValue(), 6).isEmpty() && (setCheck(Errores.array, Errores.array.length, 'Term element should have almost one Semantic element with semantic view proto->type->semantic') , true);
  ListSemantic.size_0 != 0 && !dynamicCast(dynamicCast($get_2(ListSemantic, 0), 5).getValue(), 6).isEmpty() && !dynamicCast(dynamicCast(dynamicCast($get_2(ListSemantic, 0), 5).getValue(), 6).get_1(0), 8).Multivalued && (setCheck(Errores.array, Errores.array.length, 'Semantic structure element should be multivalued') , true);
  if (ListSemantic.size_0 != 0 && !dynamicCast(dynamicCast($get_2(ListSemantic, 0), 5).getValue(), 6).isEmpty() && dynamicCast(dynamicCast(dynamicCast($get_2(ListSemantic, 0), 5).getValue(), 6).get_1(0), 8).Sons.array.length != 0) {
    console_1('TP1: ' + ListSemantic.size_0);
    console_1('TP2: ' + dynamicCast(dynamicCast($get_2(ListSemantic, 0), 5).getValue(), 6).size_1());
    console_1('TP3: ' + dynamicCast(dynamicCast(dynamicCast($get_2(ListSemantic, 0), 5).getValue(), 6).get_1(0), 8).Sons.array.length);
    console_1('TP4: ' + dynamicCast($get_3(dynamicCast(dynamicCast(dynamicCast($get_2(ListSemantic, 0), 5).getValue(), 6).get_1(0), 8).Sons, 0), 8).Shows.array.length);
    CUIBoo = false;
    for (ViewstructureJSON$iterator = new AbstractList$IteratorImpl(dynamicCast($get_3(dynamicCast(dynamicCast(dynamicCast($get_2(ListSemantic, 0), 5).getValue(), 6).get_1(0), 8).Sons, 0), 8).Shows); ViewstructureJSON$iterator.i < ViewstructureJSON$iterator.this$01_0.size_1();) {
      ViewstructureJSON = (checkCriticalElement(ViewstructureJSON$iterator.i < ViewstructureJSON$iterator.this$01_0.size_1()) , dynamicCast(ViewstructureJSON$iterator.this$01_0.get_1(ViewstructureJSON$iterator.i++), 29));
    ...
    CUIBoo?dynamicCast($get_3(dynamicCast(dynamicCast(dynamicCast($get_2(ListSemantic, 0), 5).getValue(), 6).get_1(0), 8).Sons, 0), 8).TypeOfStructure != Text_0 && (setCheck(Errores.array, Errores.array.length, 'Semantic element should have a CUI element with Text Type') , true):(setCheck(Errores.array, Errores.array.length, 'Semantic structure element should have a CUI element with CUI view proto->type->cui') , true);
  }
  for (err$iterator = new AbstractList$IteratorImpl(Errores); err$iterator.i < err$iterator.this$01_0.size_1();) {
    err = (checkCriticalElement(err$iterator.i < err$iterator.this$01_0.size_1()) , dynamicCastToString(err$iterator.this$01_0.get_1(err$iterator.i++)));
    console_1('E2:' + err);
  }
  return Errores;
}

function CompositeDocumentEditionProto(randomIdVars, contextId){
  var Errores, Gr, Gr$iterator, JSOSucion, RP, SDocumentoS, SS, T4, T5, VP, string, string$iterator, DocumentoJ;
  ...
  JSOSucion = ($clinit_JSONParser() , dynamicCast(parse_0(SDocumentoS), 21));
  ...
  if (!SS) {
    ...
    if (Errores.array.length == 0) {
      T4 = new Label;
      $setTextOrHtml(T4.directionalTextHelper, 'Ahora mismo hay que empezar a meter la informacion poco a poco');
      $add_0(VP, T4);
    }
     else {
      T4 = new Label;
      ...
      for (string$iterator = new AbstractList$IteratorImpl(Errores); string$iterator.i < string$iterator.this$01_0.size_1();) {
        string = (checkCriticalElement(string$iterator.i < string$iterator.this$01_0.size_1()) , dynamicCastToString(string$iterator.this$01_0.get_1(string$iterator.i++)));
        T5 = new Label;
...
defineClass(80, 1, {}, CompositeDocumentEditionProto);
_.Width = 0;
var Lucm_fdi_ilsa_client_CompositeDocumentEditionProto_2_classLit = createForClass('ucm.fdi.ilsa.client', 'CompositeDocumentEditionProto', 80);
function CompositeDocumentDescriptionProto(randomIdVars, contextId){
  CompositeDocumentEditionProto.call(this, randomIdVars, contextId);
}

defineClass(133, 80, {}, CompositeDocumentDescriptionProto);
var Lucm_fdi_ilsa_client_CompositeDocumentDescriptionProto_2_classLit = createForClass('ucm.fdi.ilsa.client', 'CompositeDocumentDescriptionProto', 133);
...
function CreateGramIn(gramatica){
  ...
  for (i = 0; i < gramatica.array.length; i++) {
    $set(GramarIn, i, grammarInUni((checkElementIndex(i, gramatica.array.length) , dynamicCast(gramatica.array[i], 43))));
  }
  return GramarIn;
}
...
function CreateIds(id_0){
  ...
  for (i = 0; i < id_0.array.length; i++) {
    $set(UserDoc, i, new JSONNumber(toDouble((checkElementIndex(i, id_0.array.length) , dynamicCast(id_0.array[i], 22)).value_0)));
  }
  return UserDoc;
}
...
function CreateListStruc(listaS){
  ...
  for (i = 0; i < listaS.array.length; i++) {
    $set(UserDoc, i, createStruct((checkElementIndex(i, listaS.array.length) , dynamicCast(listaS.array[i], 8))));
  }
  return UserDoc;
}
...
function CreateOperationalValues(operationalValues){
  ...
  for (i = 0; i < operationalValues.array.length; i++) {
    $set(UserDoc, i, createOperational((checkElementIndex(i, operationalValues.array.length) , dynamicCast(operationalValues.array[i], 70))));
  }
  return UserDoc;
}
...
function CreateOperationalValuesTy(operational){
  ...
  for (i = 0; i < operational.array.length; i++) {
    $set(UserDoc, i, createOperationalTy((checkElementIndex(i, operational.array.length) , dynamicCast(operational.array[i], 29))));
  }
  return UserDoc;
}
...
function CreateUserDoc(userDocument){
  ...
  for (i = 0; i < userDocument.array.length; i++) {
    $set(UserDoc, i, new JSONNumber(toDouble((checkElementIndex(i, userDocument.array.length) , dynamicCast(userDocument.array[i], 22)).value_0)));
  }
  return UserDoc;
}
...
function createStrUni(object){
  ...
  try {
    TypeOfStructureT = ($clinit_StructureJSON$TypeOfStructureEnum() , dynamicCast(valueOf(($clinit_StructureJSON$TypeOfStructureEnum$Map() , $MAP), TypeOfStructure), 34));
  }
   catch ($e0) {
    $e0 = wrap($e0);
    if (instanceOf($e0, 7)) {
...
function setContext(IdVentana, contextId, Height, isgrammar, edit, views, CompleteView){
  ...
  edit?(Actual = new CompositeDocumentEditionProto(IdVentana, contLong)):(Actual = new CompositeDocumentDescriptionProto(IdVentana, contLong));
}
